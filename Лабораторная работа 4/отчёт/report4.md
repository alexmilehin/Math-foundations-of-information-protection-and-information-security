...
subtitle: "Алгоритмы Евклида нахождения наибольшего общего делителя"
...
Пример: Найти НОД для чисел 22 и 10.
...
## Реализация алгоритмов Евклида на языке Python
...
![Пример работы алгоритмов Евклида](image/1.png){ #fig:001 width=70% height=70%}
